...
public class TurnoffResource implements OcPlatform.EntityHandler {
    private static final String TAG = TurnoffResource.class.getSimpleName();
    ...
    public TurnoffResource(Gpio ledGpio) {
        this.ledGpio = ledGpio;
        mResourceUri = "/turnoff";
